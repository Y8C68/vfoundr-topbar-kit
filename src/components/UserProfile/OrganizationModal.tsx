...
import { OrganizationSwitcherComponent, type OrganizationSwitcherProps } from '@y8c68/team-kit'
...
export interface OrganizationModalProps {
  ...
  components: OrganizationSwitcherProps['components'] & {
  ...
  // Toast function
  toast: OrganizationSwitcherProps['toast']
  // Optional customization from OrganizationSwitcherComponent
  enableDebugInfo?: OrganizationSwitcherProps['enableDebugInfo']
  showCreateButton?: OrganizationSwitcherProps['showCreateButton']
  className?: string
}
